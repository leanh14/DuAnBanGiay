...
public class QuanLyThuongHieu extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtMa, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtTen, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(136, 136, 136))
    ...
    private void btnThemLoaiSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemLoaiSPActionPerformed
        ThuongHieu lsp = getModel();
        try {
            if (check()) {
                ThuongHieu_repository.them(lsp);
                fillToTable();
                index = list.size() - 1;
   ...
   private void fillToTable() {
        try {
            list = ThuongHieu_repository.getAll();
            mol = (DefaultTableModel) tblLoaiSP.getModel();
            mol.setRowCount(0);
            for (int i = 0; i < list.size(); i++) {
                Object[] data = new Object[]{list.get(i).getID(), list.get(i).getMA(), list.get(i).getTEN()};
                mol.addRow(data);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private void showDetail() {
        ThuongHieu lsp = list.get(index);
        txtMa.setText(lsp.getMA());
        txtTen.setText(lsp.getTEN());
    }

    public ThuongHieu getModel() {
        ThuongHieu lsp = new ThuongHieu();
