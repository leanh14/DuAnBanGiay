...
public class QuanLySize extends javax.swing.JFrame {
    ...
    // End of variables declaration//GEN-END:variables
     ...
     private void fillToTable() {
        try {
            list = Size_repository.getAllSize();
            mol = (DefaultTableModel) tblLoaiSP.getModel();
            mol.setRowCount(0);
            for (int i = 0; i < list.size(); i++) {
                Object[] data = new Object[]{list.get(i).getID(), list.get(i).getMASIZE(), list.get(i).getTENSIZE()};
                mol.addRow(data);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private void showDetail() {
        Size lsp = list.get(index);
        txtMa.setText(lsp.getMASIZE());
        txtTen.setText(lsp.getTENSIZE());
    }

    public Size getModel() {
        Size lsp = new Size();
        lsp.setMASIZE(txtMa.getText());
        lsp.setTENSIZE(txtTen.getText());
        return lsp;
    }
